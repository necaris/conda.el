...
(defun conda--deprecation-workaround (string)
  "Unfortunate hack due deprecation message generated by 
   `conda ..activate` command in conda 4.6+."
  (s-replace
   "WARNING: The conda.cli.activate module is deprecated and will be removed in a future release." ""
   (s-replace
    "WARNING: The module conda.cli.activate is deprecated. It will be removed in a future feature release (i.e. minor version release)." "" string)
   ))
...
It's platform specific in that it uses the platform's native path separator."
  (s-trim (conda--deprecation-workaround
